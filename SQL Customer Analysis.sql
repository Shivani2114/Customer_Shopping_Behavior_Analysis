...
--Q1 what is thse total revenue generated by male vs female customers?
select gender, SUM(purchase_amount)
from customer
group by gender;

--Q2 Which customer used a discount but still purchases more than the average purchase amount?
...
--Q9 Are the customers who are the repeated buyers (who's previous purchases are >5) also likely to subscribe?
select subscription_status,
count(customer_id)
from customer
